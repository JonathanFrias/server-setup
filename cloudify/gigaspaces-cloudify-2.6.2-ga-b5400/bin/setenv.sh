...
#   at http://www.gigaspaces.com/wiki/display/XAP91/System+Environment+and+Environment+Variables
#  *************************************************************************
...
JAVA_OPTIONS=" ${JAVA_OPTIONS} ${COMPONENT_JAVA_OPTIONS}"
export JAVA_OPTIONS
...
LOOKUPGROUPS="gigaspaces-Cloudify-2.6.2-ga"
fi
