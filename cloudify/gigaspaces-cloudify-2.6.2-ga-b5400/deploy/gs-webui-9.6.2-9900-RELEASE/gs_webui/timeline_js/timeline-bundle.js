...
var A=this._timeline.getDocument().createElement("div");
A.setAttribute("timestamp",""+J.getStart().getTime());
...
}this._mainTitle=(A.mainTitle!=null)?SimileAjax.HTML.deEntify(A.mainTitle):"";
if(B.length>0){this._mainTitle+=" PROBLEM: "+B.join(", ");
...
},getMainTitle:function(){return this._mainTitle;
...
A.appendChild(A.ownerDocument.createElement("br"));
A.appendChild(A.ownerDocument.createTextNode(B.labelPrecise(this._end)));
}}},fillInfoBubble:function(A,F,M){var N=A.ownerDocument;
var L=this.getText();
var P=this.getMainTitle();
var I=this.getLink();
var D=this.getImage();
if(D!=null){var E=N.createElement("img");
E.src=D;
F.event.bubble.imageStyler(E);
A.appendChild(E);
}if(P.length>0){var K=N.createElement("div");
var C=N.createTextNode(P);
K.appendChild(C);
F.event.bubble.mainTitleStyler(K);
A.appendChild(K);
}var O=N.createElement("div");
var B=N.createTextNode(L);
if(I!=null){var J=N.createElement("a");
J.href=I;
J.appendChild(B);
O.appendChild(J);
}else{O.appendChild(B);
}F.event.bubble.titleStyler(O);
A.appendChild(O);
var Q=N.createElement("div");
this.fillDescription(Q);
F.event.bubble.bodyStyler(Q);
A.appendChild(Q);
var H=N.createElement("div");
this.fillTime(H,M);
F.event.bubble.timeStyler(H);
A.appendChild(H);
var G=N.createElement("div");
this.fillWikiInfo(G);
F.event.bubble.wikiStyler(G);
A.appendChild(G);
}};
...
this.event={track:{height:10,gap:2,offset:2,autoWidthMargin:1.5},overviewTrack:{offset:20,tickHeight:6,height:2,gap:1,autoWidthMargin:5},tape:{height:4},instant:{icon:Timeline.urlPrefix+"images/dull-blue-circle.png",iconWidth:10,iconHeight:10,impreciseOpacity:20,impreciseIconMargin:3},duration:{impreciseOpacity:20},label:{backgroundOpacity:50,offsetFromLine:3},highlightColors:["#FFFF00","#FFC000","#FF0000","#0000FF"],highlightLabelBackground:false,bubble:{width:250,maxHeight:0,mainTitleStyler:function(A){A.className="main-timeline-event-bubble-title";
},titleStyler:function(A){A.className="timeline-event-bubble-title";
